...
CLICKHOUSE_PORT=7002
GOOSE_DRIVER=clickhouse

GOOSE_DBSTRING="clickhouse://${CLICKHOUSE_USER}:${CLICKHOUSE_PASSWORD}@${CLICKHOUSE_HOST}:${CLICKHOUSE_PORT}/${CLICKHOUSE_DATABASE}?secure=true&skip_verify=true"
