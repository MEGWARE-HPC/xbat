...
from backend.restapi.utils.folders import owner_folder, build_folder_map, find_existing_folder, next_unique_folder_name
...
def build_restore_summary(payload, actor, restore_info):
    return {
