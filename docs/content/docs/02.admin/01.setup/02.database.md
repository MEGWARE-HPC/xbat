...
ClickHouse and Valkey require adjusting sysctl settings to prevent unpredictable behaviour and out-of-memory exceptions (see [here](https://questdb.io/docs/deployment/capacity-planning/#os-configuration){:target="\_blank"}).
